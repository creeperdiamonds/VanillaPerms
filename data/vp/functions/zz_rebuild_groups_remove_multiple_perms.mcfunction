# vp:zz_rebuild_groups_remove_multiple_perms
# Parses a comma-separated list of permissions from `action_values` and removes each one.

# --- Setup ---
# Copy the group's current permissions to a working list.
